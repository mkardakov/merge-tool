...
TESTING_TYPE="psalm-testing"

TESTING_COMMAND='echo \" Running psalm checks...\"'
TESTING_COMMAND+=" && composer psalm -- --report=/${TESTING_TYPE}/results/psalm.junit.xml || true"
...
POD_FILENAME="testing-psalm.yml"
